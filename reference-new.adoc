...
9.13.1 P14修补程序现在可用于所有云提供商的Cloud Volumes ONTAP。BlueXP将提示您将现有系统升级到此修补程序版本。

link:https://mysupport.netapp.com/site/products/all/details/cloud-volumes-ontap/downloads-tab/download/62632/9.13.1P14["查看P14修补程序中已修复的错误列表"^] (需要登录NetApp支持站点)。



== 9.13.1P13 (2025年1月20日)

9.13.1 P13修补程序现在可用于所有云提供商的Cloud Volumes ONTAP。BlueXP将提示您将现有系统升级到此修补程序版本。

link:https://mysupport.netapp.com/site/products/all/details/cloud-volumes-ontap/downloads-tab/download/62632/9.13.1P13["查看P13修补程序中已修复的错误列表"^] (需要登录NetApp支持站点)。



== 9.13.1 P12 (2024年11月25日)

9.13.1 P12修补程序现在可用于所有云提供商的Cloud Volumes ONTAP。BlueXP将提示您将现有系统升级到此修补程序版本。

link:https://mysupport.netapp.com/site/products/all/details/cloud-volumes-ontap/downloads-tab/download/62632/9.13.1P12["查看P12修补程序中已修复的错误列表"^] (需要登录NetApp支持站点)。
...
要了解更多信息、请参见 https://www.netapp.com/media/17239-tr-4598.pdf["FabricPool最佳实践指南"^]

.主动预读功能
 `Aggressive Readahead`FabricPool中的功能可能会增加文件级别的读取操作、而这反过来又会增加公共云中的读取成本和内存利用率。

要了解更多信息、请参阅ONTAP文档： https://docs.netapp.com/us-en/ontap/fabricpool/enable-disable-aggressive-read-ahead-task.html#enable-aggressive-read-ahead-mode-during-volume-creation["启用和禁用主动预读模式"^]
...
要了解更多信息、请参阅ONTAP文档： https://docs.netapp.com/us-en/ontap/fabricpool/enable-disable-volume-cloud-write-task.html["启用和禁用卷以直接写入云"^]
